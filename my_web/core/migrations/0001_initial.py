# Generated by Django 3.0.2 on 2020-05-07 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('38', '38'), ('39', '39'), ('40', '40'), ('41', '41')], max_length=120)),
                ('category', models.CharField(choices=[('S', 'Sport shoes'), ('SN', 'Sneaker'), ('SD', 'Sandal')], max_length=2)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='billing_address', to='core.ShippingAddress'),
        ),
        migrations.AddField(
            model_name='order',
            name='coupon',
